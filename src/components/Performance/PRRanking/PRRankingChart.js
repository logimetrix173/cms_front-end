...
export default function PRRankingChart({ chartData, enableScroll }) {
      ...
      return (
        <div>
          ...
          <span>
            ...
            {`Count: ${payload[0].payload.rankOneCount}`}&ensp;
  ...
  return enableScroll === true ? (
    <ResponsiveContainer style={{ height: "100%" }}>
      ...
      >
        ...
        <XAxis dataKey="Rank" fontSize={10} interval={0} stroke="black" />
